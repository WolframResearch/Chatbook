...
VerificationTest[
 Map[{#,
    CodeCheckFix[ToString[Unevaluated[Quantity[1, #]], InputForm]][
     "FixedCode"]} &,
  {"AmpereSquareMeter", "Attofarad", "AttogramPerCubicMeter",
   "Attohenry", "Attolux", "Attosiemens", "Attoweber",
   "BecquerelPerGram", "CandelaPerSquareMeter", "CentigalPerSecond",
   "Centilux", "CentinewtonMeter", "CentinewtonSecond", "Centitesla",
   "CoulombPerKilogram", "CubicMetersPerSecond", "Decamole", "Decibel",
    "DecibelPerMeter", "DeciliterPerMinute", "DecilumenMinute",
   "DeciluxSecond", "Deciparsec", "Decipascal", "DecipascalSecond",
   "DecivoltPerMeter", "Degrees", "ErgPerGram", "FemtoampereSecond",
   "FemtocoulombSeconds", "FemtohenryPerMeter", "Femtohertz",
   "Femtojoule", "FemtojoulePerKelvin", "FemtolambertSecond",
   "Femtoliter", "FemtomolePerSecond", "FemtonewtonMeter",
   "Femtosievert", "Femtotesla", "Gigacurie", "Gigafurlong",
   "Gigahertz", "Gigapascal", "GigavoltSecond",
   "GramPerCentimeterCubed", "GrayPerSecond", "Hectohertz",
   "Hectokatal", "Hectokelvin", "Hectolambert", "Hectolumen",
   "HectoluxSecond", "HectometerPerSecond", "HectopascalSecond",
   "Hectowatt", "HenryPerMeter", "HertzSecond", "JoulePerCoulomb",
   "JoulePerKelvin", "Katal", "KelvinPerWatt", "KiloampereHour",
   "Kilofurlongs", "KilogaussSecond", "KilogramsPerCubicMeter",
   "KilogramsPerMetersCubed", "KilojoulePerMole",
   "KiloluxPerSteradian", "Kilomole", "KilomolePerSecond", "Kiloohms",
    "KilopascalPerMeter", "KilowattHour", "KilowattHours",
   "KiloweberPerSecond", "LuxSecond", "Megabecquerel",
   "MegaergPerKelvin", "Megaergs", "Megagauss", "MegagramPerLiter",
   "MeganewtonMeter", "Megaoersted", "MegaohmCentimeter", "Megaparsec",
    "MegatonPerSecond", "MeterPerSecondSquared", "Microbarns",
   ...
   "Nanoradian", "NanosecondPerMeter", "Nanostoke", "Nanotesla",
   "NanoteslaSecond", "NewtonMeter", "NewtonSecond", "OhmMeter",
   "Pascalliters", "PascalSecond", "Petaampere", "Petabyte",
   "Petagram", "Petalux", "PetameterPerSecond", "Petapascal",
   "Petasiemens", "Picoampere", "PicogramPerMilliliter", "Picogray",
   "PicoohmMeter", "Picotorr", "Picowebers", "RoodPerSecond",
   "SiemensPerMeter", "SievertPerHour", "Terabit", "TeracandelaHour",
   "Teragram", "Terajoule", "TeslaSecond", "Tons", "VoltPerMeter",
   "WattPerSteradian", "Year", "Yoctosecond", "Yoctosiemens",
   "Yoctowatt", "Yottabyte", "YottameterCube", "Yottawatt",
   "Zeptocoulomb", "Zeptojoule", "Zeptolumen", "Zeptonewton",
   "Zeptosecond", "Zettajoule"}],
 {{"AmpereSquareMeter",
   "Quantity[1, \"Ampere\"*\"SquareMeters\"]"}, {"Attofarad",
   "Quantity[1, \"Attofarads\"]"}, {"AttogramPerCubicMeter",
   "Quantity[1, \"Attograms\"/\"CubicMeters\"]"}, {"Attohenry",
   Missing["Unknown unit", "Attohenry"]}, {"Attolux",
   Missing["No errors detected"]}, {"Attosiemens",
   Missing["No errors detected"]}, {"Attoweber",
   "Quantity[1, \"Attowebers\"]"}, {"BecquerelPerGram",
   "Quantity[1, \"Becquerel\"/\"Grams\"]"}, {"CandelaPerSquareMeter",
   "Quantity[1, \"Candelas\"/\"SquareMeters\"]"}, {"CentigalPerSecond",
    Missing["Unknown unit", "CentigalPerSecond"]}, {"Centilux",
   Missing["No errors detected"]}, {"CentinewtonMeter",
   "Quantity[1, \"Centinewtons\"*\"Meter\"]"}, {"CentinewtonSecond",
   "Quantity[1, \"Centinewtons\"*\"Second\"]"}, {"Centitesla",
   "Quantity[1, \"Centiteslas\"]"}, {"CoulombPerKilogram",
   "Quantity[1, \"Coulomb\"/\"Kilogram\"]"}, {"CubicMetersPerSecond",
   "Quantity[1, \"CubicMeters\"/\"Second\"]"}, {"Decamole",
   Missing["Unknown unit", "Decamole"]}, {"Decibel",
   Missing["Unknown unit", "Decibel"]}, {"DecibelPerMeter",
   Missing["Unknown unit", "DecibelPerMeter"]}, {"DeciliterPerMinute",
    "Quantity[1, \"Deciliters\"/\"Minute\"]"}, {"DecilumenMinute",
   "Quantity[1, \"Decilumens\"*\"Minute\"]"}, {"DeciluxSecond",
   "Quantity[1, \"Decilux\"*\"Second\"]"}, {"Deciparsec",
   Missing["Unknown unit", "Deciparsec"]}, {"Decipascal",
   "Quantity[1, \"Decipascals\"]"}, {"DecipascalSecond",
   "Quantity[1, \"Decipascals\"*\"Second\"]"}, {"DecivoltPerMeter",
   "Quantity[1, \"Decivolts\"/\"Meter\"]"}, {"Degrees",
   Missing["No errors detected"]}, {"ErgPerGram",
   "Quantity[1, \"Ergs\"/\"Grams\"]"}, {"FemtoampereSecond",
   "Quantity[1, \"Femtoamperes\"*\"Second\"]"}, {"FemtocoulombSeconds",
    "Quantity[1, \"Femtocoulombs\"*\"Seconds\"]"}, \
{"FemtohenryPerMeter",
   Missing["Unknown unit", "FemtohenryPerMeter"]}, {"Femtohertz",
   Missing["No errors detected"]}, {"Femtojoule",
   "Quantity[1, \"Femtojoules\"]"}, {"FemtojoulePerKelvin",
   "Quantity[1, \"Femtojoules\"/\"Kelvin\"]"}, {"FemtolambertSecond",
   Missing["Unknown unit", "FemtolambertSecond"]}, {"Femtoliter",
   "Quantity[1, \"Femtoliters\"]"}, {"FemtomolePerSecond",
   "Quantity[1, \"Femtomoles\"/\"Second\"]"}, {"FemtonewtonMeter",
   "Quantity[1, \"Femtonewtons\"*\"Meter\"]"}, {"Femtosievert",
   "Quantity[1, \"Femtosieverts\"]"}, {"Femtotesla",
   "Quantity[1, \"Femtoteslas\"]"}, {"Gigacurie",
   "Quantity[1, \"Gigacuries\"]"}, {"Gigafurlong",
   "Quantity[1, \"Gigafurlongs\"]"}, {"Gigahertz",
   Missing["No errors detected"]}, {"Gigapascal",
   "Quantity[1, \"Gigapascals\"]"}, {"GigavoltSecond",
   "Quantity[1, \"Gigavolts\"*\"Second\"]"}, {"GramPerCentimeterCubed",
    "Quantity[1, \"Grams\"/\"Centimeters\"^3]"}, {"GrayPerSecond",
   "Quantity[1, \"Gray\"/\"Second\"]"}, {"Hectohertz",
   Missing["No errors detected"]}, {"Hectokatal",
   "Quantity[1, \"Hectokatals\"]"}, {"Hectokelvin",
   "Quantity[1, \"Hectokelvins\"]"}, {"Hectolambert",
   Missing["Unknown unit", "Hectolambert"]}, {"Hectolumen",
   "Quantity[1, \"Hectolumens\"]"}, {"HectoluxSecond",
   "Quantity[1, \"Hectolux\"*\"Second\"]"}, {"HectometerPerSecond",
   "Quantity[1, \"Hectometers\"/\"Second\"]"}, {"HectopascalSecond",
   "Quantity[1, \"Hectopascals\"*\"Second\"]"}, {"Hectowatt",
   "Quantity[1, \"Hectowatts\"]"}, {"HenryPerMeter",
   "Quantity[1, \"Henry\"/\"Meter\"]"}, {"HertzSecond",
   "Quantity[1, \"Hertz\"*\"Second\"]"}, {"JoulePerCoulomb",
   "Quantity[1, \"Joule\"/\"Coulomb\"]"}, {"JoulePerKelvin",
   "Quantity[1, \"Joule\"/\"Kelvin\"]"}, {"Katal",
   Missing["No errors detected"]}, {"KelvinPerWatt",
   "Quantity[1, \"Kelvin\"/\"Watt\"]"}, {"KiloampereHour",
   "Quantity[1, \"Hour\"*\"Kiloamperes\"]"}, {"Kilofurlongs",
   Missing["No errors detected"]}, {"KilogaussSecond",
   "Quantity[1, \"Kilogauss\"*\"Second\"]"}, {"KilogramsPerCubicMeter",
    Missing["No errors detected"]}, {"KilogramsPerMetersCubed",
   "Quantity[1, \"Kilograms\"/\"Meters\"^3]"}, {"KilojoulePerMole",
   "Quantity[1, \"Kilojoules\"/\"Mole\"]"}, {"KiloluxPerSteradian",
   "Quantity[1, \"Kilolux\"/\"Steradian\"]"}, {"Kilomole",
   "Quantity[1, \"Kilomoles\"]"}, {"KilomolePerSecond",
   "Quantity[1, \"Kilomoles\"/\"Second\"]"}, {"Kiloohms",
   Missing["No errors detected"]}, {"KilopascalPerMeter",
   "Quantity[1, \"Kilopascals\"/\"Meter\"]"}, {"KilowattHour",
   "Quantity[1, \"Hour\"*\"Kilowatts\"]"}, {"KilowattHours",
   "Quantity[1, \"Hours\"*\"Kilowatts\"]"}, {"KiloweberPerSecond",
   "Quantity[1, \"Kilowebers\"/\"Second\"]"}, {"LuxSecond",
   "Quantity[1, \"Lux\"*\"Second\"]"}, {"Megabecquerel",
   "Quantity[1, \"Megabecquerels\"]"}, {"MegaergPerKelvin",
   Missing["Unknown unit", "MegaergPerKelvin"]}, {"Megaergs",
   Missing["Unknown unit", "Megaergs"]}, {"Megagauss",
   Missing["No errors detected"]}, {"MegagramPerLiter",
   "Quantity[1, \"Megagrams\"/\"Liters\"]"}, {"MeganewtonMeter",
   "Quantity[1, \"Meganewtons\"*\"Meter\"]"}, {"Megaoersted",
   Missing["Unknown unit", "Megaoersted"]}, {"MegaohmCentimeter",
   "Quantity[1, \"Centimeters\"*\"Megaohms\"]"}, {"Megaparsec",
   "Quantity[1, \"Megaparsecs\"]"}, {"MegatonPerSecond",
   Missing["Unknown unit",
    "MegatonPerSecond"]}, {"MeterPerSecondSquared",
   "Quantity[1, \"Meter\"/\"Second\"^2]"}, {"Microbarns",
   Missing["No errors detected"]}, {"Microcurie",
   "Quantity[1, \"Microcuries\"]"}, {"Microdarcy",
   Missing["Unknown unit", "Microdarcy"]}, {"Microgray",
   "Quantity[1, \"Micrograys\"]"}, {"MicrograyPerSecond",
   "Quantity[1, \"Micrograys\"/\"Second\"]"}, {"Microkayser",
   Missing["Unknown unit", "Microkayser"]}, {"Microlambert",
   "Quantity[1, \"Microlamberts\"]"}, {"Microlux",
   Missing["No errors detected"]}, {"MilesPerHour",
   ...
   "Quantity[1, \"Millirads\"]"}, {"Millisiemens",
   Missing["No errors detected"]}, {"MilliteslaMeter",
   "Quantity[1, \"Meter\"*\"Milliteslas\"]"}, {"MolePerLiter",
   "Quantity[1, \"Mole\"/\"Liters\"]"}, {"NanobarnSecond",
   "Quantity[1, \"Nanobarns\"*\"Second\"]"}, {"NanofaradSecond",
   "Quantity[1, \"Nanofarads\"*\"Second\"]"}, {"Nanogray",
   "Quantity[1, \"Nanograys\"]"}, {"NanometerPerPicosecond",
   "Quantity[1, \"Nanometers\"/\"Picoseconds\"]"}, {"NanomolePerLiter",
    "Quantity[1, \"Nanomoles\"/\"Liters\"]"}, {"Nanopascal",
   "Quantity[1, \"Nanopascals\"]"}, {"Nanoradian",
   "Quantity[1, \"Nanoradians\"]"}, {"NanosecondPerMeter",
   "Quantity[1, \"Nanoseconds\"/\"Meter\"]"}, {"Nanostoke",
   Missing["Unknown unit", "Nanostoke"]}, {"Nanotesla",
   "Quantity[1, \"Nanoteslas\"]"}, {"NanoteslaSecond",
   "Quantity[1, \"Nanoteslas\"*\"Second\"]"}, {"NewtonMeter",
   "Quantity[1, \"Meter\"*\"Newton\"]"}, {"NewtonSecond",
   "Quantity[1, \"Newton\"*\"Second\"]"}, {"OhmMeter",
   "Quantity[1, \"Meter\"*\"Ohm\"]"}, {"Pascalliters",
   Missing["Unknown unit", "Pascalliters"]}, {"PascalSecond",
   "Quantity[1, \"Pascal\"*\"Second\"]"}, {"Petaampere",
   "Quantity[1, \"Petaamperes\"]"}, {"Petabyte",
   "Quantity[1, \"Petabytes\"]"}, {"Petagram",
   "Quantity[1, \"Petagrams\"]"}, {"Petalux",
   Missing["No errors detected"]}, {"PetameterPerSecond",
   "Quantity[1, \"Petameters\"/\"Second\"]"}, {"Petapascal",
   "Quantity[1, \"Petapascals\"]"}, {"Petasiemens",
   Missing["No errors detected"]}, {"Picoampere",
   "Quantity[1, \"Picoamperes\"]"}, {"PicogramPerMilliliter",
   "Quantity[1, \"Picograms\"/\"Milliliters\"]"}, {"Picogray",
   "Quantity[1, \"Picograys\"]"}, {"PicoohmMeter",
   "Quantity[1, \"Meter\"*\"Picoohms\"]"}, {"Picotorr",
   Missing["Unknown unit", "Picotorr"]}, {"Picowebers",
   Missing["No errors detected"]}, {"RoodPerSecond",
   "Quantity[1, \"Roods\"/\"Second\"]"}, {"SiemensPerMeter",
   Missing["No errors detected"]}, {"SievertPerHour",
   "Quantity[1, \"Sievert\"/\"Hour\"]"}, {"Terabit",
   "Quantity[1, \"Terabits\"]"}, {"TeracandelaHour",
   "Quantity[1, \"Hour\"*\"Teracandelas\"]"}, {"Teragram",
   "Quantity[1, \"Teragrams\"]"}, {"Terajoule",
   "Quantity[1, \"Terajoules\"]"}, {"TeslaSecond",
   "Quantity[1, \"Second\"*\"Tesla\"]"}, {"Tons",
   Missing["Unknown unit", "Tons"]}, {"VoltPerMeter",
   "Quantity[1, \"Volt\"/\"Meter\"]"}, {"WattPerSteradian",
   "Quantity[1, \"Watt\"/\"Steradian\"]"}, {"Year",
   Missing["No errors detected"]}, {"Yoctosecond",
   "Quantity[1, \"Yoctoseconds\"]"}, {"Yoctosiemens",
   Missing["No errors detected"]}, {"Yoctowatt",
   "Quantity[1, \"Yoctowatts\"]"}, {"Yottabyte",
   "Quantity[1, \"Yottabytes\"]"}, {"YottameterCube",
   "Quantity[1, \"Cubes\"*\"Yottameters\"]"}, {"Yottawatt",
   "Quantity[1, \"Yottawatts\"]"}, {"Zeptocoulomb",
   "Quantity[1, \"Zeptocoulombs\"]"}, {"Zeptojoule",
   "Quantity[1, \"Zeptojoules\"]"}, {"Zeptolumen",
...
VerificationTest[
 {{"PerchesLength", "Kerats", "Femtohertz", "Zm", "IndianMustis",
      "Pouces"}, {"Droits", "BritishThermalUnitsMean", "PiedsDuRoi",
      "Kilofeet", "Dekayards"}, {"MilliVAs", "Tierces"}, {"Megabars",
      "GallonsUK", "GuatemalaCentavos", "RomanScriptula",
      "JovianMassParameter"}, {"Radians", "Xennameters"}, {"Hcd",
      "VDC", "BritishLivestockUnits", "KiB", "Gavyutis"}, {"Milligons",
       "ElectricConstant"}, {"Bushels53Pound",
      "Microlumens"}, {"Lactabits", "Megawebers", "ShortQuires",
      "Spheres", "Tamms", "MinimalPerceptibleErythema"}, {"Hartrees",
      "Vendekoohms", "Tt"}} // Map[StringJoin] //
   {MapApply[Times, #],
     # //
       Map[CodeCheckFix[
           ToString[Unevaluated[Quantity[1, #]], InputForm]][
          "FixedCode"] &] //
      StringCases[
       Shortest[
         StringExpression["Quantity[",  __, ",", v : __, "]"]] :>
...
VerificationTest[
 ...
 <|"ErrorsDetected" -> True,
  "CodeInspector" -> <|"InspectionObjects" -> {
CodeInspector`InspectionObject[
      "SuspiciousQuantityUnitName", "Suspicious Quantity Unit Name",
       "Fatal", <|
