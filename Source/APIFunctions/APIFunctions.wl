...
CreateChat::bdauth =
ChatEvaluate::bdauth = "Authentication method `1` is not available."
CreateChat::bdmethod = "Method `1` is not available."
ChatEvaluate::deadcon = "The linked connection is not available anymore. Use Authentication option to reconnect."
ChatEvaluate::badchat = "A valid ChatObject is expected instead of `1`."
ChatEvaluate::bdspec = "A valid message is expected instead of `1`."
