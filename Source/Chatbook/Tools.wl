...
(*
setChatPreferences0[ scope_, "Assistance"         , value_ ] := setPrefChatAssistance[ scope, value ];
setChatPreferences0[ scope_, "ChatHistoryLength"  , value_ ] := setPrefChatHistoryLength[ scope, value ];
setChatPreferences0[ scope_, "LLMEvaluator"       , value_ ] := setPrefLLMEvaluator[ scope, value ];
setChatPreferences0[ scope_, "MaxCellStringLength", value_ ] := setPrefMaxCellStringLength[ scope, value ];
setChatPreferences0[ scope_, "MergeMessages"      , value_ ] := setPrefMergeMessages[ scope, value ];
setChatPreferences0[ scope_, "Model"              , value_ ] := setPrefModel[ scope, value ];
setChatPreferences0[ scope_, "Prompts"            , value_ ] := setPrefPrompts[ scope, value ];
setChatPreferences0[ scope_, "Temperature"        , value_ ] := setPrefTemperature[ scope, value ];
setChatPreferences0[ scope_, "ToolCallFrequency"  , value_ ] := setPrefToolCallFrequency[ scope, value ];
setChatPreferences0[ scope_, "Tools"              , value_ ] := setPrefTools[ scope, value ];
*)
